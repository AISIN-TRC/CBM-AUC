...
def main():
    ...
    if args.h_type == "fcc":
        ...
        conceptizer2  = image_fcc_conceptizer(768, args.nconcepts, args.nconcepts_labeled, args.concept_dim, args.h_sparsity)
    ...
    model_aux = GSENN(conceptizer2, parametrizer2, aggregator) 
