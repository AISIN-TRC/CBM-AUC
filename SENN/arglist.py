...
def get_senn_parser():
    ...
    parser.add_argument('--h_labeled_param', type=float, default=0.1, help='parameter for learning h [default: 1-e4]')
    ...
    parser.add_argument('--print_freq' , type=int, default=100, help='print frequency during train (in batches)')
